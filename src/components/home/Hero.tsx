    ...
    return (
        <section className="relative overflow-hidden bg-white">
            ...
            <div className="pt-24 pb-0 lg:pt-32 relative z-10 flex flex-col items-center">
                ...
                {/* Google Maps Interactive Area */}
                <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-12 relative z-20">
                    <div className="w-full h-[500px] rounded-3xl overflow-hidden shadow-2xl ring-1 ring-black/5">
                        <iframe
