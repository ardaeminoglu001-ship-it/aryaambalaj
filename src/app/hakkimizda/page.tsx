...
export default function AboutPage() {
    return (
        <div className="min-h-screen flex flex-col font-sans bg-gray-50">
            ...
            <main className="flex-grow flex items-center justify-center py-20 px-4 md:px-8 lg:px-12 bg-red-900/60 backdrop-blur-sm relative">
                {/* Optional: Add a subtle overlay or background image here if needed in the future */}
                <div className="absolute inset-0 bg-[url('/noise.png')] opacity-[0.03] mix-blend-overlay"></div>
                <div className="w-full max-w-7xl mx-auto relative z-10">
                    <div className="text-center">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light tracking-widest text-white mb-10 drop-shadow-md">
                            15 YILLIK TECRÜBE
                        </h1>
                        <p className="text-white/95 text-lg md:text-xl lg:text-2xl font-sans font-light leading-loose tracking-wide max-w-4xl mx-auto drop-shadow-sm">
