...
export default function KurbanlikPosetPage() {
    const products = [
        ...
        {
            category: "Et Taşıma Poşetleri",
            items: [
                "Et Taşıma Poşeti (Küçük Boy)",
                "Et Taşıma Poşeti (Büyük Boy)"
            ]
        }
    ];
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-6 tracking-tight">
                            Kurbanlık Poşet Çeşitleri
                        </h1>
                        <p className="text-lg text-gray-600 font-sans max-w-2xl mx-auto">
                            Kurban Bayramı'na özel dayanıklı taşıma sağlayan kalın siyah naylon markiz ve hijyenik kalınlaştırılmış et taşıma poşetleri.
                        </p>
                    </motion.div>
