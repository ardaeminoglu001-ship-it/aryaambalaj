...
export default function CopPosetleriPage() {
    const products = [
        "Endüstriyel Orta Boy Kalın (20 Adet)",
        "Endüstriyel Büyük Boy Kalın (10 Adet)",
        "80x110 Kalın Çöp Poşeti (10 Adet)",
        "80x110 30 Sarımlı Çöp Torbası",
        "Büzgülü Büyük Boy Çöp Torbası",
        "Büzgülü Orta Boy Çöp Torbası",
        "İnce Market Tipi Orta Boy Çöp Torbası",
        "İnce Market Tipi Büyük Boy Çöp Torbası",
        "Mini Çöp Poşeti (40 Adet)"
    ];
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-6 tracking-tight">
                            Çöp Poşeti Çeşitleri
                        </h1>
                        <p className="text-lg text-gray-600 font-sans max-w-2xl mx-auto">
                            İşletmeler ve ev kullanımı için dayanıklı, sızdırmaz ve farklı ebatlarda toptan çöp poşeti seçenekleri.
                        </p>
                    </motion.div>
                    ...
                    >
                        <div className="bg-primary-50 p-6 border-b border-primary-100">
                            <h2 className="text-2xl font-bold text-primary-900 text-center">
                                Poşet <span className="text-primary-600 font-normal">Çeşitleri</span>
                            </h2>
                        </div>
