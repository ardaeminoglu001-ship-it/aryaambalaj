...
export default function StrecFilmPage() {
    const products = [
        {
            category: "Açık Streç Filmler",
            items: [
                "30x250 Açık Streç Film",
                "45x300 Açık Streç Film"
            ]
        },
        {
            category: "Sera Streç Filmler",
            items: [
                "30x300 Sera Düz Bıçaklı Streç Film",
                "30x1500 Sera Streç Film",
                "45x300 Sera Streç Film",
                "45x1500 Sera Streç Film"
            ]
        },
        {
            category: "İlka Streç Filmler",
            items: [
                "30x300 İlka Kaydırma Bıçaklı Streç Film"
            ]
        }
    ];
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 font-sans max-w-2xl mx-auto">
                            Gıda muhafazası, endüstriyel ambalajlama ve genel kullanım için yüksek kaliteli, yırtılmaya dirençli streç film seçenekleri.
                        </p>
                    </motion.div>
