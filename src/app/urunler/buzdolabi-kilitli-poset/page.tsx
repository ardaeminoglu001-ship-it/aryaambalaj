...
export default function BuzdolabiKilitliPosetPage() {
    const products = [
        {
            category: "Buzdolabı Poşeti (Naylon Torba)",
            items: [
                "0,5'lik Naylon Torba",
                "1'lik Naylon Torba",
                "2'lik Naylon Torba",
                "3'lük Naylon Torba",
                "4'lük Naylon Torba",
        ...
        {
            category: "Kilitli Poşet Çeşitleri",
            items: [
                "5x5 Kilitli Poşet",
                "6x7 Kilitli Poşet",
                "7x9 Kilitli Poşet",
    ...
    const handleWhatsAppClick = (productName: string, category: string) => {
        const text = `Merhaba, Arya Ambalaj internet sitesinden geliyorum. ${productName} (${category}) hakkında fiyat ve detaylı bilgi alabilir miyim?`;
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-6 tracking-tight">
                            Buzdolabı & Kilitli Poşet Çeşitleri
                        </h1>
                        <p className="text-lg text-gray-600 font-sans max-w-2xl mx-auto">
                            Gıdalarınızı güvenle saklayabileceğiniz sağlam buzdolabı poşetleri ve her ebatta sızdırmaz kilitli poşet alternatifleri.
                        </p>
                    </motion.div>
