...
export default function CatalKasikPage() {
    const products = [
        {
            category: "CHS Marka",
            items: [
                "CHS Lüx Çatal (50 Adet)",
                "CHS Lüx Kaşık (50 Adet)"
            ]
        },
        {
            category: "Ekosan Marka (Lüx Seri)",
            items: [
                "Ekosan Lüx Çatal (100 Adet)",
                "Ekosan Lüx Kaşık (100 Adet)"
            ]
        },
        {
            category: "Ekosan Marka (Eko Seri)",
            items: [
                "Ekosan Eko Çatal (100 Adet)",
                "Ekosan Eko Kaşık (100 Adet)"
            ]
        }
    ];
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 font-sans max-w-2xl mx-auto">
                            Paket servisler, piknikler ve organizasyonlar için yüksek kaliteli CHS ve Ekosan marka plastik çatal kaşık seçenekleri.
                        </p>
                    </motion.div>
