...
export default function YemekSetleriPage() {
    const products = [
        {
            category: "Standart Yemek Setleri",
            items: [
                {
                    name: "3'lü Yemek Seti",
                    includes: "Peçete, Kürdan, Tuz"
                },
                {
                    name: "4'lü Yemek Seti",
                    includes: "Peçete, Kürdan, Tuz, Çatal"
                }
            ]
        },
        {
            category: "Lüx Yemek Setleri",
            items: [
                {
                    name: "Lüx Yemek Seti",
                    includes: "Peçete, Kürdan, Tuz, Çatal, Kaşık"
                },
                {
                    name: "Lüx Yemek Seti (Islak Mendilli)",
                    includes: "Peçete, Kürdan, Tuz, Çatal, İslak Mendil"
                }
            ]
        }
    ];
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 font-sans max-w-2xl mx-auto">
                            Restoran Paket servisleriniz için pratik, şık ve hijyenik, içerikleri ambalajlı sunulan tek kullanımlık paket yemek setleri.
                        </p>
                    </motion.div>
                                            ...
                                            <li key={itemIndex} className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 rounded-xl hover:bg-zinc-50 transition-colors border border-transparent hover:border-zinc-100 shadow-sm sm:shadow-none bg-zinc-50/50 sm:bg-transparent group">
                                                <div className="flex flex-row items-center gap-4 flex-1">
                                                    ...
                                                    <div className="flex flex-col">
                                                        <span className="font-semibold text-gray-800 leading-snug sm:text-left text-center">
                                                            {item.name}
                                                        </span>
                                                        <span className="text-xs text-gray-500 mt-0.5 sm:text-left text-center">
                                                            İçindekiler: {item.includes}
                                                        </span>
                                                    </div>
                                                </div>
                                                <button
