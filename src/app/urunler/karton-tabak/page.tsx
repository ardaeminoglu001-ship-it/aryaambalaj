...
export default function KartonTabakPage() {
    const products = [
        {
            category: "Karton Tabaklar",
            items: [
                "22cm Karton Tabak",
                "28cm Karton Tabak"
            ]
        ...
        {
            category: "Çorba Kasesi & Kapaklar",
            items: [
                "Karton Çorba Kase",
                "Karton Çorba Kase Kapağı"
            ]
        }
    ];
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-lg text-gray-600 font-sans max-w-2xl mx-auto">
                            Sıcak ve soğuk sunumlar için ısıya dayanıklı karton tabaklar, dökülmez kapaklı çorba kaseleri. Paket servise tam uyumlu.
                        </p>
                    </motion.div>
