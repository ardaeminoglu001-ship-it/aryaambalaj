...
export default function RuloPosetPage() {
    const products = [
        {
            category: "Gülenyüz Baskılı Rulo",
            items: [
                "Gülenyüz Küçük Boy",
                "Gülenyüz Orta Boy",
                "Gülenyüz Büyük Boy"
        ...
        {
            category: "Unlu Mamüller Rulo",
            items: [
                "Unlu Mamüller Küçük Boy",
                "Unlu Mamüller Orta Boy",
                "Unlu Mamüller Büyük Boy"
            ]
        },
        {
            category: "Standart Rulo",
            items: [
                "Rulo Küçük Boy",
                "Rulo Orta Boy",
                "Rulo Büyük Boy"
    ...
    const handleWhatsAppClick = (productName: string) => {
        const text = `Merhaba, Arya Ambalaj internet sitesinden geliyorum. ${productName} rulo poşet hakkında fiyat ve detaylı bilgi alabilir miyim?`;
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-6 tracking-tight">
                            Rulo Poşet Çeşitleri
                        </h1>
                        <p className="text-lg text-gray-600 font-sans max-w-2xl mx-auto">
                            Manav, market ve fırın reyonları için dayanıklı, hijyenik kopardığında açılan rulo poşet (manav poşeti) alternatifleri.
                        </p>
                    </motion.div>
